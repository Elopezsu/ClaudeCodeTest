...
- **Global scope**: `/Users/eunicelopez/Desktop/ClaudeCodeTest/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/eunicelopez/Desktop/ClaudeCodeTest/.claude/notes/`)
...
2. Glob `/Users/eunicelopez/Desktop/ClaudeCodeTest/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/eunicelopez/Desktop/ClaudeCodeTest/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/eunicelopez/Desktop/ClaudeCodeTest/.claude/notes/` — works in any directory
