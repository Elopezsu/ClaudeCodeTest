...
- Usage: Reference from command with `@/Users/eunicelopez/Desktop/ClaudeCodeTest/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/eunicelopez/Desktop/ClaudeCodeTest/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/eunicelopez/Desktop/ClaudeCodeTest/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
